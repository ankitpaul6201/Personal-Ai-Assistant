    ...
    def _ssl_enabled() -> bool:
        ...
        if not key_path.exists() or not crt_path.exists():
            try:
                ...
                subject = issuer = x509.Name([x509.NameAttribute(NameOID.COMMON_NAME, "JARVIS Local Dashboard")])
                ...
                print(f"[Dashboard] Self-signed SSL cert note: {e}")
